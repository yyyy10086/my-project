...
public class SystemConstants {
    ...
    /** 区块的 Gas 上限（控制每个区块最多包含多少交易） */
    public static final long GAS_LIMIT = 10;

    /** 每笔交易默认消耗的 Gas */
    public static final long DEFAULT_GAS_USED = 1L;

    /** 交易池满多少笔时自动打包成区块 */
    public static final int BLOCK_TRANSACTION_THRESHOLD = 3;

    /** 默认挖矿难度（哈希前缀需要多少个0） */
    public static final long DEFAULT_DIFFICULTY = 4L;
